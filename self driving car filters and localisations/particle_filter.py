...
def eval(r, p):
    ...
    for i in range(len(p)): # calculate mean error
        dx = (p[i].x - r.x + (world_size/2.0)) % world_size - (world_size/2.0)  #modulo car monde cyclique de 100*100, donc si le robot est a 99.9 ou 0.1 c'est pareil presque
...
for t in range(T):
    ...
    print(eval(myrobot,p))  #print error between particle and position of robot
